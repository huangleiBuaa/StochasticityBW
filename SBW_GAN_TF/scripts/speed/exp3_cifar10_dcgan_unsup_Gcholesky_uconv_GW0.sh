...
base_name=${name%.*}
name="${base_name}"
CUDA_VISIBLE_DEVICES=0 python speed.py --name $name --dataset cifar10 --arc dcgan\
 ...
 --g_decomposition cholesky --g_iter_num 5 --g_whitten_m 0 --g_coloring_m 0 --g_instance_norm 0\
 --discriminator_norm n --discriminator_coloring n\
 --d_decomposition cholesky --d_iter_num 5 --d_whitten_m 0 --d_coloring_m 0 --d_instance_norm 0\
