...
base_name=${name%.*}
name="${base_name}"
CUDA_VISIBLE_DEVICES=3 python run.py --name $name --dataset cifar10 --arc dcgan\
 ...
 --g_decomposition zca --g_iter_num 5 --g_whitten_m 64 --g_coloring_m 0 --g_instance_norm 0\
 --discriminator_norm n --discriminator_coloring n\
 --d_decomposition zca --d_iter_num 5 --d_whitten_m 64 --d_coloring_m 64 --d_instance_norm 0\
